...
from prepdocslib.excelparser import ExcelParser
from prepdocslib.strategy import DocumentAction, SearchInfo, Strategy
from prepdocslib.textparser import TextParser
from prepdocslib.textsplitter import SentenceTextSplitter, SimpleTextSplitter, ExcelSplitter
        ...
        file_processors.update(
            {
                ...
                ".xlsx": FileProcessor(excel_parser, excel_splitter),
